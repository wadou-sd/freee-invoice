...
- 入力: freee人事労務の出勤簿PDF(従業員別・12か月分)。所定年間公休=105日(通期在籍者)
- 集計: 労働日数(有休含む)/実出勤(=労働−有休)/有休/欠勤/特別休暇(忌引等)/公休(=在籍−労働−欠勤−特別)
- 判定: 実公休 vs 所定105の差分。±0=正常、負=所定より多く出勤、正=所定超過(要精査)
- 個別ルール: 加藤裕は別休日制度(1/1〜5/31隔週2日・6/1〜12/31週休2日、所定≒93日)
- 按分: 期中入社者は在籍日数で所定を按分(例 櫻井=入社7/1・在籍355日→所定約102)
- 2025年度実績: 雄大±0/宮崎±0/裕-2(別制度で正常)/櫻井-12(出勤過多)/長谷川+14
- 長谷川: 有休以外の休みは私傷病(病欠=欠勤)。所定超過14日を欠勤へ振替。決算賞与6%減額(会社決定)
  ※6%は出勤率換算14/260≒5.4%を会社方針で設定。規程整合・病欠免除規定は要確認(社労士範囲)
- 成果物: 勤怠サマリー_賞与査定_YYYYMM-YYYYMM.xlsx(9タブ+減額シミュレーション)。基本賞与を入れると減額後を自動算出
- 未確定: 長谷川の病欠実日付(現状9〜10月に7+7で仮計上)。基本賞与額(未入力)
